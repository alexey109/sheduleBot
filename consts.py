...
CMD_KEYWORDS = {		
	...
	CMD_WHEN_EXAMS		: [u'осталось', u'сесси[ия]', u'прошло', u'пройден', u'семестр', u'каникулы'],
...
USER_PREMESSAGE = {
	...
	CMD_HELP			: u'Инструкция:\nПросто спросите что-нибудь по расписанию пар. '\
		...
		+ u'В групповых беседах необходимо обращаться "раписание, ..."\n\n'
	...
	CMD_WHEN_EXAMS		: u'Зачетная неделя с 22 декабря.\nЭкзамены с 9 по 30 января.\n'\
		+ u'Каникулы с 31 января по 7 февраля.\n',
	CMD_FIND_LECTION	: u''
}
