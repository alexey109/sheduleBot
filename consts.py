...
KEYWORDS = {		
	...
	CMD_LECTION_COUNTER : [
		u'счетчик',
		u'((сколько)|(осталось)|(кол(ичест)|(-)во)|(список)).*((пар)|(занятий))',
		u'((пар)|(занятий)).*((сколько)|(осталось)|(кол(ичест)|(-)во)|(список))',
	],
	CMD_WHEN_EXAMS		: [
		u'осталось',
		u'прошло[^й]?', 
	...
	CMD_MYID			: [u'id', u'логин', u'пароль', u'уведомления', u'напомин'],
